 ...
 **********************************/
#define SVP_DSP_OFFSET_PTR_2NX8U(  ptr, nrows, stride, in_row_offset) ((xb_vec2Nx8U*)   ((uint8_t*) (ptr)+(in_row_offset)+(nrows)*(stride)))
#define SVP_DSP_OFFSET_PTR_N_2X32U(ptr, nrows, stride, in_row_offset) ((xb_vecN_2x32Uv*)((uint32_t*)(ptr)+(in_row_offset)+(nrows)*(stride)))
#define SVP_DSP_OFFSET_PTR_N_2X32( ptr, nrows, stride, in_row_offset) ((xb_vecN_2x32v*) ((int32_t*) (ptr)+(in_row_offset)+(nrows)*(stride)))
#define SVP_DSP_OFFSET_PTR_NX16U(  ptr, nrows, stride, in_row_offset) ((xb_vecNx16U*)   ((uint16_t*)(ptr)+(in_row_offset)+(nrows)*(stride)))
#define SVP_DSP_OFFSET_PTR_NX16(   ptr, nrows, stride, in_row_offset) ((xb_vecNx16*)    ((int16_t*) (ptr)+(in_row_offset)+(nrows)*(stride)))
#define SVP_DSP_OFFSET_PTR_N_2X16( ptr, nrows, stride, in_row_offset) ((xb_vecN_2x16*)  ((int16_t*) (ptr)+(in_row_offset)+(nrows)*(stride)))
#define SVP_DSP_OFFSET_PTR_NX8U(   ptr, nrows, stride, in_row_offset) ((xb_vecNx8U*)    ((uint8_t*) (ptr)+(in_row_offset)+(nrows)*(stride)))
#define SVP_DSP_OFFSET_PTR_NX8(    ptr, nrows, stride, in_row_offset) ((xb_vecNx8*)     ((int8_t*)  (ptr)+(in_row_offset)+(nrows)*(stride)))
#define SVP_DSP_OFFSET_PTR_2NX8(   ptr, nrows, stride, in_row_offset) ((xb_vec2Nx8*)    ((int8_t*)  (ptr)+(in_row_offset)+(nrows)*(stride)))
